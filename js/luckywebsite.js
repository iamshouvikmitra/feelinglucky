function uselessWebButton( button, popup ) {
	...
	var onButtonClick = function() {
		...
		openSite( url );
		document.getElementById('luckyUrl').innerHTML= url;
		

		// Change text from "FEELING MORE"
		if ( initialClick === false ) {
			document.getElementById( 'joint' ).innerHTML = 'FEELING MORE';
			initialClick = true;
			document.getElementById('is').style.display = "block";
			document.getElementById('luckyUrl').style.display = "block";
		}
